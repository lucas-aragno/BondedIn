...
STATICFILES_DIRS = (
    ...
    '/home/lucas/BondedInrepo/static/',
)
...
SECRET_KEY = 'jx-j@kcy%t2mrlpllo!le%mngktjj+1(6er3a8*-v5b2i5r)tz'
...
ROOT_URLCONF = 'BondedIn.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'BondedIn.wsgi.application'
